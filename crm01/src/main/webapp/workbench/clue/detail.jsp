    ...
    $(function(){
        ...
        $("#aname").keydown(function (event) {
            if(event.keyCode==13){
                ...
                //展现完列表后，将系统默认的回车禁用，否则当前页的数据会自动清空
                return false;
            }
        })
        ...
        $("#bundBtn").click(function(){
            ...
            if($xz.length==0){
                ...
                //workbench/clue/bund.do?cid=xxx&aid=xxx&aid=xxxx&aid=xxx
                var param = "cid=${c.id}&";
					...
					<div class="btn-group" style="position: relative; top: 18%; left: 8px;">
						<form class="form-inline" role="form">
						  <div class="form-group has-feedback">
						    ...
						    <span cla   ss="glyphicon glyphicon-search form-control-feedback"></span>
						  </div>
						</form>
					</div>
