...
<c:set var="name" value="tianalu"></c:set>
<%
...
<script type="text/javascript">
	$(function(){
		...
		//为市场活动源中的模态窗口 搜索框绑定事件 执行搜索并展现市场活动列表
        ...
        $("#convertBtn").click(function () {
            ...
            //请求结束后，最终响应回线索列表页
            //根据 为客户创建交易的复选框有没有挑√  来判断是否需要创建交易
            if($("#isCreateTransaction").prop("checked")){
                //需要创建交易
                //为后台传交易表单中的信息，金额，预计成交日期，交易名称，阶段，市场活动源（id）
                //为防止后续信息更改，超出浏览器地址栏长度上线，以提交表单的形式发送本次传统请求
...
<body>
	...
	<div id="title" class="page-header" style="position: relative; left: 20px;">
		<h4>转换线索 <small>${param.fullname}${param.appellation}-${param.company}-动力节点</small></h4>
	</div>
	<div id="create-customer" style="position: relative; left: 40px; height: 35px;">
		新建客户12：${param.company}
	</div>
	...
	//提交表单结果为： workbench/clue/convert.do？clueId=xxx&money=xx&..
