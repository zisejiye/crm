...
<script type="text/javascript" src="jquery/bs_typeahead/bootstrap3-typeahead.min.js"></script>
    <script type="text/javascript">
        //声明一个json对象，将pMap对象的key，value放入json串中
        var json  ={
            <%for(String key:set){
        ...
        $(function(){
            ...
            $("#create-stage").change(function () {
                ...
                //当json中的key是不确定的多种数据时不能以json.key的形式获取value而是以json[key]形式获取
...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm"  method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="百度2">
                <input type="hidden" name="activityId" value="0e2c840cbaa945f5bd0d809bccdd8321">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-contactsName" value="码云">
                <input type="hidden" name="contactsName" value="68550207a1d9452c9412e88a7b3fc99a">
			</div>
		</div>
